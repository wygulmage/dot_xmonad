...
## Courtesy of Giorgos Keramidas (https://keramida.wordpress.com/2013/03/28/controlling-the-keyboard-backlight-from-cli/)
# backlight_get
...
backlight_change()
{
    ...
    [1234567890]|[[1234567890][[1234567890])
        ...
        if test ${value} -lt 0 || test ${value} -gt ${max} ; then
            ...
            backlight_set "${value}"
#            notify-send -t 100 "Keyboard brightness set to ${value}"
        fi
        ;;
...
if test $# -eq 0 ; then
    ...
    notify-send -t 80 "Keyboard brightness is ${current_brightness}"
else
